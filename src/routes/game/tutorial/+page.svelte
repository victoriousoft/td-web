...
<div class="m-auto mx-5 max-w-4xl md:mx-auto md:w-3/4">
	<section class="items-left flex flex-col">
		<h2 class="my-4 text-left text-2xl">Introduction</h2>
		<div class="text-lg">
			<p>
				A local park is being taken over by various evil creatures. The cats are the only ones who can save the park from the invasion. You are the
				commander of the cat army and your task is to build towers to defend the park from the enemies and not let any of them reach the end. (level
				image)
			</p>
		</div>
	</section>
	...
	<section class="items-left flex flex-col">
		<h2 class="my-4 text-left text-2xl">Building towers</h2>
		<div class="text-lg">
			<p>You can chose from four classes of towers:</p>
	...
	<section class="items-left flex flex-col">
		...
		<p>
			...
			defense. After that, waves spawn automatically although you can call them earlier if you feel confident to receive a small amount of bonus gold.
			If an Enemy manages to pass through your defense, you will lose a certain amount of lives, if you run out of lives, you lose the game and have
			to start over.
		</p>
	</section>
</div>
